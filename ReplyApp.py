...
Usage of the model in this app is tied directly to my OpenAI account, so I have put a hard limit of $0.5 of usage per month. If an error occurs when attempting to generate a reponse, this likely means that this monthly limit has been reached.
